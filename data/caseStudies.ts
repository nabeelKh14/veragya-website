export const caseStudies = [
  {
    ...
    project_title: "Full CLO 3D development for a premium resortwear collection — 24 styles from sketch to manufacturing files.",
  ...
  },
  {
    main_image_src:
      "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=800&q=80",
    project_title: "3D garment animations and pattern engineering for an activewear startup's debut line.",
    logo_src: "/placeholder-logo.svg",
    description:
      "Created dynamic 3D garment animations showcasing movement, fit, and fabric behavior for 12 activewear styles. Delivered precise 2D patterns and Illustrator files for manufacturing.",
    features: [
      "Produced 12 animated 3D garment presentations demonstrating stretch, compression, and movement for investor pitches.",
      "Engineered graded patterns with seam allowance and notches — directly importable into Gerber/Lectra systems.",
    ],
    case_study_link: "#",
    name: "KineticWear",
    demo_images: [
    ...
    testimonial: `"The 3D animations helped us secure our seed round. Investors could see exactly how the garments move and fit before we ever cut fabric."`,
    founder_name: "Arjun Kapoor",
    position: "Founder, KineticWear",
  },
  {
    main_image_src:
      "https://images.unsplash.com/photo-1485462537746-965f33f7f6a7?w=800&q=80",
    project_title: "CLO 3D files and Illustrator tech packs for a sustainable denim brand's capsule collection.",
    logo_src: "/placeholder-logo.svg",
    description:
