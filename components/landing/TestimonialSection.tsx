    ...
    <>
      ...
      >
        ...
        <SectionHeading
          ...
          description="Fashion brands and designers trust Veragya for precision, creativity, and production-ready deliverables."
          size="md"
          align="center"
          as="h2"
            ...
            <div className="flex flex-col divide-y divide-gray-200 sm:divide-y-0 sm:flex-row sm:divide-x">
              ...
              >
                ...
                <p className="text-label mt-1 text-sm sm:mt-2 sm:text-base">
                  Garment styles designed & delivered
                </p>
              </div>
              ...
              >
                ...
                <p className="text-label mt-1 text-sm sm:mt-2 sm:text-base">
                  Average reduction in sampling costs
                </p>
              </div>
            </div>
          </div>
