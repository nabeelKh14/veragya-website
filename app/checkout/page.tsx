...
export default function CheckoutPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.projectDescription.trim()) {
      ...
      newErrors.projectDescription = "Please provide more details about your project (at least 20 characters)";
    }
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-muted/50 rounded-lg p-4 mt-6">
                    <p className="text-sm text-muted-foreground">
                      <strong>Note:</strong> Final pricing may vary based on project
                      complexity. We'll confirm the exact quote within 24 hours of
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  ...
                  get back to you within 24 hours with a detailed quote and
                  project timeline.
                </p>
